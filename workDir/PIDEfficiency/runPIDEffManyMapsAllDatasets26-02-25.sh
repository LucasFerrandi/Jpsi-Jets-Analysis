...
OUTPUT_DIR="output/FullStatY" #! ATENTION: Must be changed by hand!

# MC_LIST=(LHC25b14 LHC25b15 LHC25b16 LHC25b17)
MC_LIST=(LHC25b17) #! ATENTION: Must be changed by hand!

DATASETS_DIR="/home/ferrandi/alice/datasets/MC/derivedMC/myTableMakerMCNoPID25-11-19/completeDatasets/"
AO2D_LIST=()

for i in "${MC_LIST[@]}"; do
    # AO2D_LIST+=("$DATASETS_DIR/$i/jobs/034${i}/hy_343${i}000/0001/AO2D.root")
    AO2D_LIST+=("@$DATASETS_DIR$i/inputCorrect10Percent.txt")
done
