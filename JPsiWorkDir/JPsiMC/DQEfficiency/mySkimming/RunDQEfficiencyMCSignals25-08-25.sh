...
o2-analysis-dq-efficiency-with-assoc $BATCH --internal-dpl-aod-reader "--aod-file-entry-min 0 --aod-file-entry-max 2" --run --configuration json://$JSON --aod-writer-keep AOD/RTDIELECTRONALL/0 --shm-segment-size 8000000000 --aod-memory-rate-limit 500000000 #--aod-parent-access-level 1
