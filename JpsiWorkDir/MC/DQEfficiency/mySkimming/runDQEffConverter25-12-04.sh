...
#,AOD/RTDIELECTRON/0,AOD/RTDIELECTRONALL/0
o2-analysis-dq-model-converter-mc-reduced-event "$BATCH" --configuration json://"$JSON"  
# o2-analysis-mccollision-converter --configuration json://"$JSON"
